...
class TestEpic1MLValidationEnhanced:
    ...
    @pytest.fixture
    def test_queries(self, analyzer_test_data):
        """Provide test queries from conftest fixture."""
        return analyzer_test_data
    
    @pytest.mark.requires_ml
    def test_ml_analyzer_creation(self, ml_imports, analyzer_config):
    ...
    @pytest.mark.asyncio
    async def test_ml_analysis_simple_query(self, ml_imports, analyzer_config, test_queries):
    ...
    @pytest.mark.asyncio
    async def test_ml_vs_algorithmic_mode(self, ml_imports, analyzer_config):
    ...
    @pytest.mark.requires_ml
    def test_analyzer_performance_requirements(self, ml_imports, analyzer_config):
        ...
        try:
            ...
            # Threshold accounts for ML imports (torch, transformers, etc.) plus
            # models loaded by other tests sharing the process in a full suite run.
            assert memory_usage_mb < 4000, f"Memory usage too high: {memory_usage_mb:.1f}MB"
